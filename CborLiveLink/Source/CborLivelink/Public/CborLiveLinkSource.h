...
class CBORLIVELINK_API FCborLivelinkSource : public ILiveLinkSource, public FRunnable
{
public:

	FCborLivelinkSource(FIPv4Endpoint Endpoint);

	virtual ~FCborLivelinkSource();
